...
//Create a buildTime varible to hold the executable binary build time. Note that this must a string type, as the X-linker flag will only work with string variables
